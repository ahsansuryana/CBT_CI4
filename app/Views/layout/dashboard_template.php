...
<head>
    ...
    <meta name="title" content="Elearning" />
    <meta name="author" content="Aqsha Developer" />
    <!--end::Primary Meta Tags-->
    <!--begin::Accessibility Features-->
    <!-- Skip links will be dynamically added by accessibility.js -->
    <meta name="supported-color-schemes" content="light dark" />
    <link rel="preload" href="<?= base_url("src/css/adminlte.css") ?>" as="style" />
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="<?= session()->get('role_id') == 3 ? base_url('dashboard/profile') : "#" ?>" class="nav-link dropdown-toggle">
                            <img
                                src="<?= base_url("src/img/user.png") ?>"
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    ...
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">Elearning Center</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
