...
<body>
    ...
    <div class="register-box">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <small id="passwordError" class="text-danger"><?= (isset(session()->getFlashdata('error')["password"])) ? session()->getFlashdata('error')['password'] : "" ?></small>
            ...
            <div class="form-group">
                ...
                <small id="confirmError" class="text-danger"><?= (isset(session()->getFlashdata('error')["confirm"])) ? session()->getFlashdata('error')['confirm'] : "" ?></small>
            </div>
    ...
    <script>
        ...
        document.getElementById("password").addEventListener('input', (e) => {
            const err = validatePassword(document.getElementById("password").value);
            err ? showError('passwordError', err) : clearError('passwordError');
            // Validasi ulang konfirmasi jika sedang diketik
            const confirmErr = validateConfirm(document.getElementById("confirm"), e.target.value);
            confirmErr ? showError('confirmError', confirmErr) : clearError('confirmError');
        });
        ...
        document.getElementById("confirm").addEventListener('input', (e) => {
            ...
            err ? showError('confirmError', err) : clearError('confirmError');
        });
    </script>
</body>
